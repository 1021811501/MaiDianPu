...
//        [self.navigationBar setValue:[UIColor colorWithHexString:@"#ffffff" andAlpha:1] forKeyPath:@"barTintColor"];
        [self.navigationBar setTintColor:[UIColor colorWithHexString:@"#333333" andAlpha:1]];
        [self.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#333333" andAlpha:1]}];
    }
}
@end
